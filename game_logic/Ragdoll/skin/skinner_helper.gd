...
func set_skin(skin: CharacterSkin):
	...
	sprite_head.texture = skin.head
	sprite_left_forearm.texture = skin.ul_arm
	sprite_left_arm.texture = skin.ll_arm
	sprite_right_forearm.texture = skin.ur_arm
	sprite_right_arm.texture = skin.lr_arm
	sprite_left_upper_leg.texture = skin.ul_leg
	sprite_left_lower_leg.texture = skin.ll_leg
	sprite_right_upper_leg.texture = skin.ur_leg
	sprite_right_lower_leg.texture = skin.lr_leg
